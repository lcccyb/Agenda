...
<div class="container">
    ...
    <h3 class="demo-panel-title">Change Password Operation</h3>
    <form action="ChangePasswordOperation.jsp" method="post">
        ...
        <label class="alert-danger" style="position: relative; margin-left: 310px; margin-top: 40px;">  Change password Failed! Please try again!  </label>
        <br>
