...
<div class="container">
    ...
    <form action="ChangeEmailOperation.jsp" method="post">
        ...
        <label class="alert-danger" style="position: relative; margin-left: 310px; margin-top: 40px;">  Change Email Failed! Please try again!  </label>
        <br>
