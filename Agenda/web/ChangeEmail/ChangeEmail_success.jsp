...
<div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="ChangeEmail.jsp">Change Email</a></li>
    ...
    <form action="ChangePasswordOperation.jsp" method="post">
        ...
        <div class="col-xs-3" style="width: 500px; position:relative; margin-left: 200px;">
            <div class="form-group has-feedback">
                Input Your new Email Address: <input type="text" value="" placeholder="Email Address!" class="form-control" name="newEmail" />
                <span class="input-icon fui-check-inverted"></span>
            </div>
        </div>
        <label class="alert-success" style="position: relative; margin-left: 350px; margin-top: 40px;">  Change Email succeed!  </label>
        <br>
        <label class="alert-success" style="position: relative; margin-left: 310px; margin-top: 40px;">  Change Email Failed! Please try again!  </label>
