    ...
    <small>Free Meetings Administration System</small>
        ...
        <div class="login-screen">
          ...
          <div class="login-form"style="position:absolute; top:90px; width:400px;">
            ...
            <div class="form-group">
              <input type="password" class="form-control login-field" value="" placeholder="Enter your password" id="login-pass" />
            ...
            <div class="form-group">
              <input type="text" class="form-control login-field" value="" placeholder="Enter your Phone" id="login-name" />
              <label class="login-field-icon fui-user" for="login-pass"></label>
            </div>
